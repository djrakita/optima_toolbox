...
pub struct DifferentiableFunctionIKObjective<'a, T, C, L, FQ, Q>
    ...
    constant_selector: Option<ParryPairSelector>,
    dis_filter_cutoff: T,
    linf_dis_cutoff: f64,
