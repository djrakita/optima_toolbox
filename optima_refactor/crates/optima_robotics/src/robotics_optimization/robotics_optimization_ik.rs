...
use optima_proximity::pair_group_queries::{OPairGroupQryTrait, OwnedPairGroupQry, PairGroupQryOutputCategoryParryDistance, PairGroupQryOutputCategoryParryFilter, ParryFilterOutput, ParryPairSelector, ProximityLossFunction, ToParryProximityOutputTrait};
use optima_proximity::shapes::ShapeCategoryOParryShape;
use crate::robot::ORobot;

pub struct IKObjective<C: O3DPoseCategory + 'static, L: OLinalgCategory + 'static, FQ, Q>(PhantomData<(C, L, FQ, Q)>) where FQ: OPairGroupQryTrait<ShapeCategory=ShapeCategoryOParryShape, SelectorType=ParryPairSelector, OutputCategory=PairGroupQryOutputCategoryParryFilter>,
...
impl<C: O3DPoseCategory + 'static, L: OLinalgCategory + 'static, FQ, Q> DifferentiableFunctionTrait for IKObjective<C, L, FQ, Q> where FQ: OPairGroupQryTrait<ShapeCategory=ShapeCategoryOParryShape, SelectorType=ParryPairSelector, OutputCategory=PairGroupQryOutputCategoryParryFilter>,
                                                                                                                                       Q: OPairGroupQryTrait<ShapeCategory=ShapeCategoryOParryShape, SelectorType=ParryPairSelector, OutputCategory=PairGroupQryOutputCategoryParryDistance> {
    ...
    fn call<'a, T1: AD>(inputs: &[T1], args: &Self::ArgsType<'a, T1>) -> Vec<T1> {
        ...
        if args.collision_avoidance_weight > T1::zero() {
            let proximity_value = distance_output.get_proximity_objective_value(T1::constant(0.6), T1::constant(10.0), ProximityLossFunction::Hinge);
...
pub struct IKArgs<'a, T: AD, C: O3DPoseCategory + 'static, L: OLinalgCategory + 'static, FQ, Q> where FQ: OPairGroupQryTrait<ShapeCategory=ShapeCategoryOParryShape, SelectorType=ParryPairSelector, OutputCategory=PairGroupQryOutputCategoryParryFilter>,
                                                                                                      Q: OPairGroupQryTrait<ShapeCategory=ShapeCategoryOParryShape, SelectorType=ParryPairSelector, OutputCategory=PairGroupQryOutputCategoryParryDistance> {
    pub robot: Cow<'a, ORobot<T, C, L>>,
    pub goals: Vec<IKGoal<T, C::P<T>>>,
    pub filter_output: RwLock<Option<ParryFilterOutput>>,
    pub filter_query: OwnedPairGroupQry<'a, T, FQ>,
    pub distance_query: OwnedPairGroupQry<'a, T, Q>,
...
impl<'a, T: AD, C: O3DPoseCategory + 'static, L: OLinalgCategory + 'static, FQ, Q> IKArgs<'a, T, C, L, FQ, Q> where FQ: OPairGroupQryTrait<ShapeCategory=ShapeCategoryOParryShape, SelectorType=ParryPairSelector, OutputCategory=PairGroupQryOutputCategoryParryFilter>,
                                                                                                                    Q: OPairGroupQryTrait<ShapeCategory=ShapeCategoryOParryShape, SelectorType=ParryPairSelector, OutputCategory=PairGroupQryOutputCategoryParryDistance> {
    pub fn new(robot: Cow<'a, ORobot<T, C, L>>, goals: Vec<IKGoal<T, C::P<T>>>, filter_query: OwnedPairGroupQry<'a, T, FQ>, distance_query: OwnedPairGroupQry<'a, T, Q>, init_state: Vec<T>, ee_matching_weight: T, collision_avoidance_weight: T, min_vel_weight: T, min_acc_weight: T, min_jerk_weight: T) -> Self {
...
pub struct IKArgsPrep<C: O3DPoseCategory + 'static, L: OLinalgCategory + 'static, FQ, Q> where FQ: OPairGroupQryTrait<ShapeCategory=ShapeCategoryOParryShape, SelectorType=ParryPairSelector, OutputCategory=PairGroupQryOutputCategoryParryFilter>,
                                                                                               Q: OPairGroupQryTrait<ShapeCategory=ShapeCategoryOParryShape, SelectorType=ParryPairSelector, OutputCategory=PairGroupQryOutputCategoryParryDistance> {
    last_proximity_filter_state: RwLock<Option<Vec<f64>>>,
    linf_norm_cutoff: f64,
    phantom_data: PhantomData<(C, L, FQ, Q)>
}
impl<C: O3DPoseCategory + 'static, L: OLinalgCategory + 'static, FQ, Q> IKArgsPrep<C, L, FQ, Q> where FQ: OPairGroupQryTrait<ShapeCategory=ShapeCategoryOParryShape, SelectorType=ParryPairSelector, OutputCategory=PairGroupQryOutputCategoryParryFilter>,
                                                                                                      Q: OPairGroupQryTrait<ShapeCategory=ShapeCategoryOParryShape, SelectorType=ParryPairSelector, OutputCategory=PairGroupQryOutputCategoryParryDistance> {
