...
use optima_3d_spatial::optima_3d_pose::{O3DPoseCategoryIsometry3, O3DPoseCategoryTrait};
use optima_linalg::{OLinalgCategoryNalgebra, OLinalgCategoryTrait};
...
impl RoboticsOptimizationUtils {
    ...
    pub fn get_f64_and_ad_robots<E: DerivativeMethodTrait, C: O3DPoseCategoryTrait + 'static, L: OLinalgCategoryTrait + 'static>(robot_name: &str) -> (ORobot<f64, C, L>, ORobot<E::T, C, L>) {
