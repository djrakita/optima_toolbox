...
fn main() {
    ...
    r.add_chain(c1, 0, 0, &ImplicitDualQuaternion::identity(), [0.,0.,1.], OJointType::Fixed, OJointLimit::default());
    r.add_chain(c2, 0, 0, &ImplicitDualQuaternion::from_translation_and_rotation_constructor(&[0.,0.,0.], &[0.0; 3]), [0.,0.,1.], OJointType::Fixed, OJointLimit::default());
